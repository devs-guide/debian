...
require_contains "docs/cli/ipmctl/readme.md" '/var/lib/ansible/debian/ipmctl/receipt.json'
require_contains "docs/cli/ipmctl/readme.md" '~/.cache/ansible/ipmctl/runs/'
