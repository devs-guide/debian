...
rc=0
CONTRACT_HELPER="${ROOT}/actions/lib/contracts.sh"

if [[ ! -r "${CONTRACT_HELPER}" ]]; then
  echo "[validate.runtime][error] shared contract helper is unavailable: ${CONTRACT_HELPER}"
  exit 1
fi
...
files=(
  ...
  "actions/fixtures/nvidia-topology.gpu0-gpu1.txt"
  "actions/fixtures/nvidia-topology.gpu1-gpu0.txt"
  "actions/test.documentation-contract.sh"
  "actions/test.gpu-contract.sh"
  "actions/test.ipmctl-contract.sh"
  "actions/test.ipmctl-source-build.sh"
  "actions/test.llm-host-contract.sh"
  "actions/test.llm-source-contract.sh"
  "actions/test.nvidia-contract.sh"
  "actions/test.nvidia-facts.sh"
  "actions/test.nvlink-contract.sh"
  "actions/test.publication-manifest.sh"
  "actions/test.runner-contract.sh"
  ...
  "docs/actions/test/documentation-contract/readme.md"
  "docs/actions/test/nvidia-contract/readme.md"
  "docs/actions/test/gpu-contract/readme.md"
  "docs/actions/test/ipmctl-contract/readme.md"
  "docs/actions/test/llm-host-contract/readme.md"
  "docs/actions/test/llm-source-contract/readme.md"
  "docs/actions/test/runner-staging/readme.md"
  "docs/actions/test/nvidia-facts/readme.md"
  "docs/actions/test/nvlink-contract/readme.md"
  "docs/actions/test/publication-manifest/readme.md"
  "docs/actions/test/runner-contract/readme.md"
  "docs/actions/library/readme.md"
  ...
  "actions/fixtures/llm-host/lscpu-parse.txt"
  "actions/fixtures/llm-host/meminfo.txt"
...
run_contract_action "actions/test.documentation-contract.sh"
run_contract_action "actions/test.publication-manifest.sh"
run_contract_action "actions/test.runner-contract.sh"
run_contract_action "actions/test.gpu-contract.sh"
run_contract_action "actions/test.ipmctl-contract.sh"
run_contract_action "actions/test.llm-host-contract.sh"
run_contract_action "actions/test.llm-source-contract.sh"
run_contract_action "actions/test.nvidia-contract.sh"
run_contract_action "actions/test.nvlink-contract.sh"
