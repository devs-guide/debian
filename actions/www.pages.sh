...
main() {
  ...
  local -a root_files=(
    ...
    "setup/autologin.sh:setup/autologin"
    ...
    "setup/cli/kiosk.app.sh:setup/cli/kiosk.app"
    "setup/cli/x11.sh:setup/cli/x11.sh"
    "setup/cli/x11.sh:setup/cli/x11"
    "setup/cli/openbox.sh:setup/cli/openbox.sh"
    "setup/cli/openbox.sh:setup/cli/openbox"
    "setup/cli/touchscreen.sh:setup/cli/touchscreen.sh"
    "setup/cli/touchscreen.sh:setup/cli/touchscreen"
